...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($productManager->addProduct($product_name, $product_handle, $description, $price, $category_id, $image_path)) {
...
<div class="container mt-5">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="product_handle" name="product_handle" required>
        </div>
        <div class="mb-3">
